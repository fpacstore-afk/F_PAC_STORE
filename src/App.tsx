    ...
    <Router>
      ...
      <AuthProvider>
          <div className="min-h-[100dvh] bg-[#ffffff] text-gray-800 font-sans flex flex-col overflow-x-hidden" translate="no">
            ...
            <a
              href="https://wa.me/5547997465602?text=Olá!%20Vim%20pelo%20site%20e%20gostaria%20de%20atendimento."
              target="_blank"
            ...
            >
              ...
              <span className="absolute right-full mr-3 bg-black text-white text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-none opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap border border-white/10">
                 Atendimento
              </span>
            </a>
          </div>
