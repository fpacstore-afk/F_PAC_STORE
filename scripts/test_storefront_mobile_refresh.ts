...
assert.match(navbar, /to="\/catalog\/all\?line=prime"/, 'the PRIME collection menu must open registered PRIME products');
...
assert.match(app, /path="\/model\/prime" element=\{<Navigate to="\/catalog\/all\?line=prime"/, 'legacy PRIME route must redirect to registered PRIME products');
